...
export function PostDivePrompt({ source, siteId = null, onDismiss, onLogged, className = "" }: PostDivePromptProps) {
  ...
  return (
    <div
      ...
      className={`w-full max-w-sm rounded-2xl border border-zinc-200 bg-white p-4 shadow-lg dark:border-depth-border dark:bg-depth-1 ${className}`}
    >
      <div className="flex items-start justify-between gap-2">
        ...
        <button
          ...
          className="shrink-0 rounded-full p-1 text-zinc-400 hover:bg-zinc-100 hover:text-zinc-600 dark:hover:bg-depth-2 dark:hover:text-zinc-300"
        >
      ...
      <div className="mt-3 flex gap-2">
        <button
          type="button"
          onClick={onDismiss}
          className="flex-1 rounded-xl border border-zinc-300 px-3 py-2 text-sm font-medium text-zinc-600 hover:bg-zinc-50 dark:border-depth-border dark:text-zinc-300 dark:hover:bg-depth-2"
        >
          Not now
        </button>
        <button
